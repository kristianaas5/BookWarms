...
namespace BookWarms.Data
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Library>().HasQueryFilter(l => !l.IsDeleted);
            ...
            modelBuilder.Entity<ReadingStat>()
                .HasOne<Library>()
                .WithMany()
            ...
            modelBuilder.Entity<Library>().HasData(
                new Library { Id = 1, UserId = 1, BookId = 1, ShelfType = ShelfType.Read },
                new Library { Id = 2, UserId = 1, BookId = 2, ShelfType = ShelfType.CurrentlyReading },
                new Library { Id = 3, UserId = 2, BookId = 3, ShelfType = ShelfType.Read },
                new Library { Id = 4, UserId = 2, BookId = 4, ShelfType = ShelfType.Read },
                new Library { Id = 5, UserId = 3, BookId = 5, ShelfType = ShelfType.Read },
                new Library { Id = 6, UserId = 3, BookId = 6, ShelfType = ShelfType.Read },
                new Library { Id = 7, UserId = 4, BookId = 7, ShelfType = ShelfType.Read },
                new Library { Id = 8, UserId = 4, BookId = 8, ShelfType = ShelfType.Read },
                new Library { Id = 9, UserId = 5, BookId = 9, ShelfType = ShelfType.Read },
                new Library { Id = 10, UserId = 5, BookId = 10, ShelfType = ShelfType.WantToRead }
            );            


            modelBuilder.Entity<User>().HasData(
                new User { Id = 1, Username = "Admin: Kristiana Stoyanova", Email = "krisistoyanova2008@gmail.com" },
            ...
            modelBuilder.Entity<Book>().HasData(
                new Book { Id = 1, Title = "The Great Gatsby", Author = "F. Scott Fitzgerald", Genre = "Classic", Description = "A novel set in the Roaring Twenties.", PageCount = 180 },
                new Book { Id = 2, Title = "1984", Author = "George Orwell", Genre = "Dystopian", Description = "A story about a totalitarian regime.", PageCount = 328 },
            ...
            modelBuilder.Entity<Review>().HasData(
                new Review { Id = 2, LibraryId = 1, Rating = 4, ReviewText = "A delightful read!", Date = new DateTime(2025, 7, 9) },
                new Review { Id = 3, LibraryId = 2, Rating = 5, ReviewText = "A powerful story about justice.", Date = new DateTime(2025, 7, 10) },
                new Review { Id = 1, LibraryId = 1, Rating = 5, ReviewText = "A timeless classic!", Date = new DateTime(2025, 7, 8)
                }
            );
            modelBuilder.Entity<ReadingStat>().HasData(
                ...
                new ReadingStat { Id = 1, UserId = 1, Year = 2025, BooksRead = 2, PagesRead = 508 }
            );
